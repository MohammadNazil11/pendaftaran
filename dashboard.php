              ...
              <div class="card-body">
                  ...
                  <form class="user" method="POST" action="<?= $base_url ?>/siswa/dashboard.php">
                      <div class="form-group">
                          <label for="un">Nilai Rata-RataUjian Nasional</label>
                          <input type="number" class="form-control" id="un" placeholder="Masukkan Nilai Rata-Rata Ujian Nasional" name="un">
                      </div>
                      <hr>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di MA NURUL HUDA . Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">juni 2024</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">MA NURUL HUDA</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di MA NURUL HUDA. Lakukan Daftar Ulang pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">12 juli 2024</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">MA NURUL HUDA</marquee>
                  </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p class="text-danger mt-3">* Wajib melakukan Daftar Ulang pada tanggal: 1 JULI 2024</p>
            </div>
          </div>
        </div>
